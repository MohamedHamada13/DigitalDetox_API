...
namespace DigitalDetox.Infrastructure.Migrations
{
    ...
    [Migration("20250506144150_CreateRestPasswordFlow")]
    partial class CreateRestPasswordFlow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalDetox.Core.Entities.AuthModels.OtpCode", b =>
                {
            ...
            modelBuilder.Entity("DigitalDetox.Core.Entities.Models.App", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalDetox.Core.Entities.Models.DetoxPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 5, 6, 17, 41, 49, 70, DateTimeKind.Local).AddTicks(5471));
            ...
            modelBuilder.Entity("DigitalDetox.Core.Entities.Models.UserUsageLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AppId", "UserId", "DailyLogDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("DigitalDetox.Core.Entities.Models.UserUsageLog", b =>
                {
                    b.HasOne("DigitalDetox.Core.Entities.Models.App", "App")
                        .WithMany("DailyLogs")
                        .HasForeignKey("AppId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
