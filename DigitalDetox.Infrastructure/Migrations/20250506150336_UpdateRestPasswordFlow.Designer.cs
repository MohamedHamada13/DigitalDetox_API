...
namespace DigitalDetox.Infrastructure.Migrations
{
    ...
    [Migration("20250506150336_UpdateRestPasswordFlow")]
    partial class UpdateRestPasswordFlow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalDetox.Core.Entities.Models.DetoxPlan", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 5, 6, 18, 3, 35, 85, DateTimeKind.Local).AddTicks(238));
